const translations = {
  es: {
    ...
    loteA_ed1: "Casa principal (casco) — estilo colonial pampeano, 1865",
    loteA_ed2: "Casa de huéspedes — a reparar",
    loteA_ed3: "Casa del casero — a reparar",
    loteA_ed4: "Galpón con 6 boxes para caballos",
    ...
    loteB_desc: "Frente a la antigua Ruta Provincial N° 2. Ideal para desarrollo independiente o acceso vehicular directo.",
    ...
    ficha2_desc: "Separada del casco principal. Gran potencial de restauración.",
    ficha3_name: "Casa del Casero",
    ficha3_desc: "Vivienda para personal de campo.",
    ficha4_name: "Galpón / Caballerizas",
    ficha4_desc: "6 boxes para caballos. Infraestructura ecuestre completa para polo.",
    ...
    ficha7_desc: "Arboleda centenaria, jardín único. Grandes espacios verdes excepcionales.",
    ...
    mapa_aeropuerto: "Aeropuerto Ezeiza: ~2 hs",
  ...
  en: {
    ...
    loteA_ed1: "Main house (casco) — colonial pampeano style, 1865",
    loteA_ed2: "Guest house — needs renovation",
    loteA_ed3: "Caretaker's house — needs renovation",
    loteA_ed4: "Barn with 6 horse stalls",
    ...
    mapa_aeropuerto: "Ezeiza Airport: ~2 hrs",
